...
// @ts-nocheck 
/*
 * This file exports the `HistorySale` model and its related types.
 *
...
export type GetHistorySaleAggregateType<T extends HistorySaleAggregateArgs> = {
      [P in keyof T & keyof AggregateHistorySale]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateHistorySale[P]>
    : Prisma.GetScalarType<T[P], AggregateHistorySale[P]>
}
...
type GetHistorySaleGroupByPayload<T extends HistorySaleGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<HistorySaleGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof HistorySaleGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], HistorySaleGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], HistorySaleGroupByOutputType[P]>
      }
    >
  >
...
export type HistorySaleCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<HistorySaleFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface HistorySaleDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['HistorySale'], meta: { name: 'HistorySale' } }
  /**
   ...
   * })
  **/
  count<T extends HistorySaleCountArgs>(
    args?: Prisma.Subset<T, HistorySaleCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], HistorySaleCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends HistorySaleGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, HistorySaleGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetHistorySaleGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
